...
// Menus
add_action('init'                       , array('Bundle\AdminBundle\Application\Hook', 'register_menus'));

// Custom Type
// add_action('init'                       , array('Bundle\AdminBundle\Application\CustomType', 'sampleType'));
add_action('init'                       , array('Bundle\AdminBundle\Application\CustomType', 'artType'));

// Metabox
// add_filter('rwmb_meta_boxes'            , array('Bundle\AdminBundle\Application\Metabox\Custom', 'registerMetaBoxes'));
add_filter('rwmb_meta_boxes'            , array('Bundle\AdminBundle\Application\Metabox\Page', 'registerMetaBoxes'));
add_filter('rwmb_meta_boxes'            , array('Bundle\AdminBundle\Application\Metabox\Art', 'registerMetaBoxes'));

// Taxonomy
// add_action('init'                       , array('Bundle\AdminBundle\Application\Taxonomy', 'type'));
add_action('init'                       , array('Bundle\AdminBundle\Application\Taxonomy', 'art_range'));
